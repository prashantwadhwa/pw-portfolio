...
export const Bio = {
  ...
  description:
    "I am a Tech Geek and skilled Web Developer. With a dedicated YouTube Channel, I've fostered a community of over 6000 Subscribers, where I delve into comprehensive reviews of the latest Tech Gadgets, sharing my passion with fellow enthusiasts. My creative prowess extends further as a UI/UX Designer, allowing me to artistically communicate stories that linger in memory...",
  github: "https://github.com/prashantwadhwa",
  resume:
    "https://drive.google.com/file/d/15zYpunLUzqNkpS_OSoV1rX58Akyc2koN/view?usp=sharing",
  linkedin: "https://www.linkedin.com/in/prashantwadhwa19/",
  youtube: "https://www.youtube.com/prashantwadhwa/",
  twitter: "https://twitter.com/wadhwa1prashant",
  insta: "https://www.instagram.com/prashantyt19/",
  dribbble: "https://dribbble.com/prashantyt19",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      {
        name: "Chakra UI",
        image: "https://image.pngaaa.com/704/7959704-middle.png",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Adobe Premeire Pro",
        image:
          "https://logodownload.org/wp-content/uploads/2019/10/adobe-premiere-pro-logo-0-1.png",
      },
      {
        name: "Postman",
        image:
...
export const experiences = [
  ...
  },
  {
    ...
    desc: "As a Graphics Designer at Trendy Vibes, I crafted compelling visuals for t-shirt designs that captured the essence of the brand. My role involved creating original illustrations, icons, and layouts that brought the brand's vision to life on t-shirts.",
    skills: [
      "Leadership",
      "Figma",
      "Adobe Photoshop",
  ...
  },
  {
    ...
    date: "2020 - Present",
    desc: "Video Creator and Editor for my YouTube Channel. I create quality Tech Reviews on YouTube! ",
    skills: [
      "Adobe Premeire Pro",
      "Adobe Photoshop",
      "Adobe After Effects",
...
export const education = [
  ...
  {
    id: 1,
    img: "https://mppskkr.com/assets/img/logo/4.png",
    school: "Maharana Pratap Public School, Kurukshetra",
    date: "2019 - 2020",
    grade: "85%",
    desc: "I completed my class 12 high school education at Maharana Pratap Public School, where I studied Non Medical(Science, with Mathematics).",
  ...
  },
  {
    ...
    date: "2017-2018",
    grade: "82%",
    desc: "I completed my class 10 education at Maharana Pratap Public School, Kurukshetra.",
...
export const projects = [
...

  {
    ...
    category: "figma projects",
    github: "",
    webapp: "https://dribbble.com/shots/21211813-Sign-Up-Page-Daily-UI-001",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    category: "figma projects",
    github: "",
    webapp: "https://dribbble.com/shots/21243060-Calculator-Design-Daily-UI-4",
  },
  {
    id: 5,
    ...
    category: "figma projects",
    github: "",
    webapp: "https://dribbble.com/shots/21301361-404-Error-Page-Daily-UI-008",
  },
  {
    id: 5,
    title: "E-Commerce Shop",
    description:
      "Here's a Layout of an  E-Commerce Shop Checkout Page I made using Figma!.",
    image:
      "https://cdn.dribbble.com/userupload/6698154/file/original-892699bbbdcc2f288c93b0c748c13441.png?resize=1024x765",
    tags: ["Figma"],
    category: "figma projects",
    github: "",
    webapp:
...

  {
    ...
    description:
      "Welcome to StudyNotion, your gateway to a world of educational possibilities. Dive into a comprehensive online learning experience that caters to learners of all ages and levels. Explore interactive courses, video lessons, and engaging quizzes designed to make learning exciting and effective. Our intuitive platform fosters a seamless connection between students and educators, promoting knowledge exchange and growth. Whether you're a student seeking academic excellence or an educator aiming to inspire, StudyNotion is your partner in the journey of education. Join us today and redefine the way you learn and teach.",
    image:
